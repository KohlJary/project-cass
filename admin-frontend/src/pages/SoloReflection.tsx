...
export function SoloReflection() {
  ...
  // Auto-enable polling when there's an active session
  useEffect(() => {
  ...
  return (
    <div className="solo-reflection-page">
      <header className="page-header">
        ...
        <p className="subtitle">Cass's private contemplation sessions (local Ollama processing)</p>
      </header>

      <div className="reflection-layout">
        {/* Left column: Stats and session list */}
