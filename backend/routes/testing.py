...
# Cross-context analyzer instance (initialized in main_sdk.py)
cross_context_analyzer = None


def init_cross_context_analyzer(analyzer):
    """Initialize the cross-context analyzer."""
    global cross_context_analyzer
    cross_context_analyzer = analyzer
...
async def get_context_profiles():
    ...
    profiles = cross_context_analyzer.get_all_profiles()
...
async def get_specific_context_profile(context: str):
    ...
    profile = cross_context_analyzer.get_context_profile(ctx)
    if not profile:
...
async def analyze_cross_context_consistency():
    ...
    score = cross_context_analyzer.analyze_consistency()
...
async def get_consistency_history(limit: int = 10):
    ...
    reports = cross_context_analyzer.get_recent_consistency_reports(limit=limit)
...
async def get_research_questions():
    ...
    reports = cross_context_analyzer.get_recent_consistency_reports(limit=1)
